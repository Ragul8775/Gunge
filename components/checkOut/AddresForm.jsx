        ...
        <div className="mt-5 bg-creamLight rounded-lg shadow">
          ...
          <div className="flex flex-row-reverse p-3">
            <div className="flex-initial pl-3">
              <button
                type="button"
                className="flex items-center px-5 py-2.5 font-medium tracking-wide text-white capitalize bg-brown rounded-md hover:bg-gray-800 focus:outline-none focus:bg-gray-900 transition duration-300 transform active:scale-95 ease-in-out"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="24px"
        ...
        {/* <div className="mt-5  shadow cursor-pointer rounded-xl px-3 flex flex-col gap-3 font-sans">
          <div className="flex items-center bg-white px-2 rounded-lg gap-3">
            <div className="flex-1 py-2 pl-1 overflow-hidden">
              <ul>
                <li className="text-xs text-gray-600 uppercase font-semibold">
                  Address 1
                </li>
                <li className="font-bold">Rick Astley</li>
                <li className="itlaic text-[14px]">Rickrolled 11</li>
                <li className="itlaic text-[14px]">1000 Vienna</li>
              </ul>
            </div>
            <div className="flex-none pt-2.5 pr-2.5 pl-1">
              <button
                type="button"
                className=" font-medium tracking-wide text-black capitalize transition duration-300 ease-in-out transform rounded-xl hover:bg-gray-300 focus:outline-none active:scale-95"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="24px"
